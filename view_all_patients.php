...
<a href="patients.php" class="float-left btn btn-dark" id="arrow"><i class="fa fa-arrow-left" style='font-size:24px'></i></a>
	<div class="container">
       <div class="card">
		  <div class="card-body">
				<?php
			 ...
			 <table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="View_each_patients.php?editId=<?php echo $val['MRN'];?>" class="text-primary"><i class="fa fa-fw fa-eye"></i>View</a>  
