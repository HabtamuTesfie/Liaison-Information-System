...
<?php
	...
	{
	$error="";
	$msg="<br><span id=msg>Referral Data Successfully Recorded!!!</span><br><br>";
...
<?php include('include/sidebar1.php');?>
		...
		$query =mysqli_query($server,"SELECT * FROM patients WHERE MRN  = '". $MRN ."'"); 
			while($row=mysqli_fetch_row($query))
                ...
                {
			$error="<br><span class=error>Patient with this MRN is not registered.</span><br><br>";	
			   }
          		else
				{
...
$in_ch=mysqli_query($server,"INSERT INTO referral (MRN,user_id,pname,age,sex,woreda,
	dateReferral,type,way,reason,sender,
	diagnosis,treatment,appropriate,
	feedback)
	VALUES ('$MRN','$user_id','$pname','$age','$sex','$woreda','$dateReferral',
...
if($in_ch==1)  
   ...
   {  
	...
	<a href="<?php echo $_SERVER['PHP_SELF'];?>"class="btn btn-secondary" id="refresh"><i class="fa fa-fw fa-sync"></i> Refresh</a>				 
	    <center><h1 >Referral-IN Form</h1> </center>
	        <div class="col-lg-12 ">
	          <div class="row">
					<form  method="post">
					<div class="col-sm-12">
				...
				<div class="row">
					...
					<span id="error" style="color: Red; display: none">* Input digits (0 - 9)</span>
						...
						<div class="col-sm-6 form-group">
								<label>Date of referral recieved <span class="text-danger" style="font-size:28px"> *</span></label>
				...
				<div class="row">
				  ...
				  <div class="row">
					...
					<div class="col-sm-6 form-group">
                       ...
                       <div class="col-sm-6 form-group">
								<label>Referred from(Name of health facility) <span class="text-danger" style="font-size:28px"> *</span></label>
