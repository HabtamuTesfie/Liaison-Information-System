...
if(isset($_REQUEST['user_id']) and $_REQUEST['user_id']!=""){
	...
	$userData	=	$db->getAllRecords('feedback','*',$condition,'ORDER BY fed_id DESC');
	?>
			 ...
			 <table class="table table-hover">
				...
				$a=$_SESSION['user_id'];
					...
					<tr>
						...
						<td>
							<a href="editFeedbackSent.php?editId=<?php echo $val['fed_id'];?>" class="text-primary"><i class="fa fa-fw fa-eye"></i>View</a> | 
							<a href="deleteFeedbackSent.php?delId=<?php echo $val['fed_id'];?>" class="text-danger" onClick="return confirm('Are you sure to delete this data?');"><i class="fa fa-fw fa-trash"></i> Delete</a>
						</td>
