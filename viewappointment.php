							...
							<div class="col-sm-2">
								<div class="form-group">
									...
									<div>
										...
										&nbsp &nbsp &nbsp &nbsp 
										<a href="Appointment.php" class="btn btn-success"><i class="fa fa-fw fa-plus-circle"></i> Add New Appointment</a>
										&nbsp &nbsp &nbsp &nbsp &nbsp  
										<a href="View_All_appointment.php" class="btn btn-success"><i class="fa fa-fw fa-eye"></i>View All</a>
										</div>
								</div>
							</div>
				...
				<tbody>
                  ...
                  $a=$_SESSION['user_id'];					
					...
					<tr>
						...
						<td align="center">
							<a href="editappointment.php?editId=<?php echo $val['App_id'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a> | 
							<a href="deleteappointment.php?delId=<?php echo $val['App_id'];?>" class="text-danger" onClick="return confirm('Are you sure to delete this appointment?');"><i class="fa fa-fw fa-trash"></i> Delete</a>
						</td>
