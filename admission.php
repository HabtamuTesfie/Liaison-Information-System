...
<?php include('include/sidebar1.php');?>
	...
	if(isset($_REQUEST['accident']) and $_REQUEST['accident']!=""){
		$condition	.=	' AND accident LIKE "%'.$_REQUEST['accident'].'%" ';
		}
		...
		if(isset($_REQUEST['population']) and $_REQUEST['population']!=""){
		$condition	.=	' AND population LIKE "%'.$_REQUEST['population'].'%" ';
	}
	...
	$userData	=	$db->getAllRecords('admission','*',$condition,'ORDER BY pat_id DESC');
	?>
	
		<div class="container">
         <a href="view_all_admission.php" id="view">View All</a>
	<div class="container">
			 ...
			 <table class="table table-hover">
				...
				$a=$_SESSION['user_id'];
					...
					<tr>
	                    ...
	                    <td><?php echo $val['NCoD'];?></td>
						<td><?php echo $val['result'];?></td>
						<td><?php echo $val['resultTB'];?></td>
						
						
						
		                 <td>
							<a href="edit-patients.php?editId=<?php echo $val['pat_id'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a>  
							<a href="deleteAdmission.php?delId=<?php echo $val['pat_id'];?>" class="text-danger" onClick="return confirm('Are you sure to delete this patient?');"><i class="fa fa-fw fa-trash"></i> Delete</a>
						</td>
