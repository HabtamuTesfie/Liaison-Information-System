...
try {
  ...
  $result = $conn->query('SELECT NCoD, concat((count( * ) *100 / (SELECT count( * ) FROM `discharge`)) , "%") AS percent FROM `discharge` GROUP BY NCoD ');
  $rows = array();
  $table = array();
  $table['cols'] = array(
