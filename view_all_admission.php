...
<?php include('include/sidebar1.php');?>
	...
	?>
	<a href="admission.php" class="float-left btn btn-dark" id="arrow"><i class="fa fa-arrow-left" style='font-size:24px'></i></a>
	<div class="container">
				...
				<tbody>
					...
					<tr>
						...
						<td><?php echo $val['resultTB'];?></td>
		                 ...
		                 <td>
							<a href="view_each_admission.php?editId=<?php echo $val['pat_id'];?>" class="text-primary"><i class="fa fa-fw fa-eye"></i>View</a>  
