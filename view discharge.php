...
<?php include('include/sidebar1.php');?>
	...
	<div class="container">
         <a href="view_all_discharge.php" id="view">View All</a>
	     <div class="container">
				...
				$a=$_SESSION['user_id'];
					...
					<tr>
						...
						<td><?php echo $val['charged'];?></td>
						 <td>
							<a href="edit discharge.php?editId=<?php echo $val['dis_id'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a> | 
							<a href="deleteDischarge.php?delId=<?php echo $val['dis_id'];?>" class="text-danger" onClick="return confirm('Are you sure to delete this patient?');"><i class="fa fa-fw fa-trash"></i> Delete</a>
						</td>
