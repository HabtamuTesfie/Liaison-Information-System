...
<?php include('include/sidebar1.php');?>
	...
	<a href="view referralin.php" class="float-left btn btn-dark" id="arrow"><i class="fa fa-arrow-left" style='font-size:24px'></i></a>
		  <div class="card">
		  <div class="card-body">
				<?php
			 ...
			 <table class="table table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center">
							<a href="view_each_referralIn.php?editId=<?php echo $val['ref_id'];?>" class="text-primary"><i class="fa fa-fw fa-eye"></i>View</a>  
