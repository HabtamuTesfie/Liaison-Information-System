							...
							<div class="col-sm-2">
								<div class="form-group">
									...
									<div>
										...
										<a href="requestReferral.php" class="btn btn-success"><i class="fa fa-fw fa-plus-circle"></i> Add New Request</a>
										&nbsp &nbsp &nbsp &nbsp &nbsp  
										<a href="view_all_request_referral.php" class="btn btn-success"><i class="fa fa-fw fa-eye"></i>View All</a>
			 ...
			 <table class="table table-hover">
				...
				$a=$_SESSION['user_id'];
					...
					<tr>
						...
						<td align="center">
							<a href="editRequestReferral.php?editId=<?php echo $val['fed_id'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a> | 
							<a href="deleteRequestReferral.php?delId=<?php echo $val['fed_id'];?>" class="text-danger" onClick="return confirm('Are you sure to delete this request?');"><i class="fa fa-fw fa-trash"></i> Delete</a>
						</td>
