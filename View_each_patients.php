...
<br><br>
		...
		?>
		<div class="card">
			<div><a href="view_all_patients.php" class="float-left btn btn-dark"><i class="fa fa-arrow-left" style='font-size:24px'></i></a></div>
			<div class="card-body">
			...
			<div class="form-group">
                    ...
                    <div class="col-sm-9">
					   ...
					   onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;"
					   pattern=".{13,}" required value="<?php echo $row[0]['phone']; ?>"  />
					  <span id="error" style="color: Red; display: none">* Input digits (0 - 9)</span>
                    </div>
             </div>	
