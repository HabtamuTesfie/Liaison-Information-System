...
<?php include('include/sidebar1.php');?>
	...
	$userData	=	$db->getAllRecords('referralout','*',$condition,'ORDER BY refout_id DESC');
	?>
	<a href="view_all_referralOut.php" id="view">View All</a>
	<div class="card">
				...
				<thead>
					<tr>
					   <th>Serial No</th>
						...
						<th>Sex</th>
						<th>Woreda</th>
						<th>Date of referral made</th>
						<th>Types of referral</th>
						<th>Referred To(Name of health facility)</th>
						<th>Action</th>
				...
				<tbody>
                  ...
                  $a=$_SESSION['user_id'];					
					...
					<tr>
	                    ...
	                    <td align="center">
							<a href="editreferralout.php?editId=<?php echo $val['refout_id'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a> | 
							<a href="deletereferralout.php?delId=<?php echo $val['refout_id'];?>" class="text-danger" onClick="return confirm('Are you sure to delete this patient?');"><i class="fa fa-fw fa-trash"></i> Delete</a>
						 </td>
